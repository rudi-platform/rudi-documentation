...
Si vous n'avez pas encore accès à un noeud producteur, vous pouvez prendre contact avec l'animateur de l'instance Rudi via le formulaire en ligne (*https://rudi.fr/?contact*).

L'animateur vous recontactera le plus rapidement possible

De la documentation est d'ores et déjà disponible à l'adresse [suivante](https://rudi.fr/?LeNoeudProducteurV23NouvellesFonctionnal).
